//! # ZeroBuild Robot Kit
//!
//! A standalone robotics toolkit that integrates with ZeroBuild for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  ZeroBuild AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use zerobuild_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of ZeroBuild. It defines its own
//! `Tool` trait that is compatible with ZeroBuild's but doesn't require it.
//!
//! ## Safety
//!
