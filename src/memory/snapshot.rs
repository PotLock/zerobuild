...
const SNAPSHOT_HEADER: &str = "# 🧠 ZeroBuild Memory Snapshot\n\n\
    > Auto-generated by ZeroBuild. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 ZeroBuild Memory Snapshot

> Auto-generated by ZeroBuild.
...
I am ZeroBuild, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 ZeroBuild Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
