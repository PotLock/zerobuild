...
const OTP_ISSUER: &str = "ZeroBuild";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(zerobuild_dir);
...
pub fn secret_file_path(zerobuild_dir: &Path) -> PathBuf {
    zerobuild_dir.join(OTP_SECRET_FILE)
}
