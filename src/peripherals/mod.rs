...
/// Handle `zerobuild peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: zerobuild peripheral add <board> <path>");
                println!("  Example: zerobuild peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
