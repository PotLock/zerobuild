...
impl From<crate::config::SopExecutionMode> for SopExecutionMode {
    fn from(mode: crate::config::SopExecutionMode) -> Self {
        match mode {
            crate::config::SopExecutionMode::Auto => Self::Auto,
            crate::config::SopExecutionMode::Supervised => Self::Supervised,
            crate::config::SopExecutionMode::StepByStep => Self::StepByStep,
            crate::config::SopExecutionMode::PriorityBased => Self::PriorityBased,
        }
    }
}

impl From<SopExecutionMode> for crate::config::SopExecutionMode {
    fn from(mode: SopExecutionMode) -> Self {
        match mode {
            SopExecutionMode::Auto => Self::Auto,
            SopExecutionMode::Supervised => Self::Supervised,
            SopExecutionMode::StepByStep => Self::StepByStep,
            SopExecutionMode::PriorityBased => Self::PriorityBased,
        }
    }
}
