//! Example: Implementing a custom Memory backend for ZeroBuild
//!
...
// ── Re-define the trait types (in your app, import from zerobuild::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 ZeroBuild Memory Demo — InMemoryBackend\n");
