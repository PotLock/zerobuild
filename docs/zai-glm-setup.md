...
ZeroBuild supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current ZeroBuild provider behavior.

## Overview

ZeroBuild supports these Z.AI aliases and endpoints out of the box:
...
### Test with ZeroBuild CLI

```bash
# Test agent directly
echo "Hello" | zerobuild agent
