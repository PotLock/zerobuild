# ZeroBuild PR Workflow (High-Volume Collaboration)

This document defines how ZeroBuild handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to ZeroBuild/project-native labels.
...
- Confirm any required identity-like wording uses ZeroBuild/project-native terminology.
