...
## Problem
ZeroBuild logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/zerobuild/audit.key"
...
zerobuild audit --user @alice

# Show all high-risk commands
zerobuild audit --risk high

# Show violations from last 24 hours
zerobuild audit --since 24h --violations-only

# Export to JSON for analysis
zerobuild audit --format json --output audit.json
