...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/theonlyhennygod/zerobuild/security/advisories/new)
...
ZeroBuild Docker images follow CIS Docker Benchmark best practices:
...
docker run --read-only -v /path/to/workspace:/workspace zerobuild gateway
```
