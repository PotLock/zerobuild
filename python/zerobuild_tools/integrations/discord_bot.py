"""
Discord bot integration for ZeroBuild.
"""
...
class DiscordBot:
    """
    Discord bot powered by ZeroBuild agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install zerobuild-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"ZeroBuild Discord Bot ready: {self.client.user}")
