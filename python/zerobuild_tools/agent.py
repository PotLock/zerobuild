...
SYSTEM_PROMPT = """You are ZeroBuild, an AI assistant with tool access. Use tools to accomplish tasks.
...
def create_agent(
    ...
    """
    Create a ZeroBuild agent with LangGraph-based tool calling.
    ...
    Example:
        ```python
        from zerobuild_tools import create_agent, shell, file_read
