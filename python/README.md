...
Python companion package for [ZeroBuild](https://github.com/zerobuild-labs/zerobuild) — LangGraph-based tool calling for consistent LLM agent execution.
...
```bash
pip install zerobuild-tools[discord]
```
