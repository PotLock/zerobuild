# ZeroBuild ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for ZeroBuild edge scenarios on ESP32.
...
```bash
cd firmware/zerobuild-esp32-ui
cargo build --release
...
3. Connect UI state with ZeroBuild edge/runtime messaging
...
- [ZeroBuild Hardware Design](../../docs/hardware-peripherals-design.md)
