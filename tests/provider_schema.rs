...
use zerobuild::providers::compatible::AuthStyle;
use zerobuild::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use zerobuild::providers::compatible::OpenAiCompatibleProvider;
